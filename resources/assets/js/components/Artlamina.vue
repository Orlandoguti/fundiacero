                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="laminacion in arrayArticulo" :key="laminacion.id">
                                    <td v-text="laminacion.codigo"></td>
                                    <td v-text="laminacion.nombre"></td>
                                    <td v-text="laminacion.nombre_categoria"></td>
                                    <td v-text="laminacion.precio_venta"></td>
                                    <td v-text="laminacion.stock"></td>
                                    <td v-text="laminacion.descripcion"></td>
                                    <td>
                                        <div v-if="laminacion.condicion">
                                    ...
                                    <td>
                                        <button type="button" @click="abrirModal('laminacion','actualizar',laminacion)" class="btn btn-warning btn-sm">
                                          <i class="icon-pencil"></i>
                                        </button> &nbsp;
                                        <template v-if="laminacion.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarArticulo(laminacion.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarArticulo(laminacion.id)">
